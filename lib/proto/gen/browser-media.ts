...
function createBaseMediaState_ResourceLinks(): MediaState_ResourceLinks {
  return { trackUrl: undefined, albumUrl: undefined, artistUrl: undefined };
}

export const MediaState_ResourceLinks = {
  fromJSON(object: any): MediaState_ResourceLinks {
    return {
      trackUrl: isSet(object.track_url) ? globalThis.String(object.track_url) : undefined,
      albumUrl: isSet(object.album_url) ? globalThis.String(object.album_url) : undefined,
      artistUrl: isSet(object.artist_url) ? globalThis.String(object.artist_url) : undefined,
    };
  },

  toJSON(message: MediaState_ResourceLinks): unknown {
    const obj: any = {};
    if (message.trackUrl !== undefined) {
      obj.track_url = message.trackUrl;
    }
    if (message.albumUrl !== undefined) {
      obj.album_url = message.albumUrl;
    }
    if (message.artistUrl !== undefined) {
      obj.artist_url = message.artistUrl;
    }
    return obj;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<MediaState_ResourceLinks>, I>>(object: I): MediaState_ResourceLinks {
    ...
    message.trackUrl = object.trackUrl ?? undefined;
    message.albumUrl = object.albumUrl ?? undefined;
    message.artistUrl = object.artistUrl ?? undefined;
    return message;
  },
};
